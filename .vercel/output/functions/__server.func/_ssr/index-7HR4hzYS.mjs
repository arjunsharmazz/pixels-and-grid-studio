...
function PixelCursor({ dark = false }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("canvas", { ref: canvasRef, className: "pointer-events-none fixed inset-0 z-40" });
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Panel, { id: "intro", width: "100vw", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 pt-28 pb-20 pl-32 pr-14 grid grid-cols-12 grid-rows-6 gap-x-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { className: "col-span-12 row-span-1 flex items-center gap-3 text-[10px] uppercase tracking-[0.3em] text-[#6A6A6A]", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto", children: "N 38.72 / W 9.13 — Lisbon" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { "data-guard": "hero-headline", className: "col-span-8 row-span-4 font-display text-balance leading-[0.86] tracking-[-0.05em] self-center", style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-12 row-span-1 self-end flex justify-between text-[10px] uppercase tracking-[0.3em] text-[#6A6A6A]", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Brand · Product · Motion · Web" }),
...
function WorkPanel() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { id: "work", width: "180vw", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 pt-20 pb-20 pl-28 pr-20 flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end justify-between mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-[0.3em] text-[#6A6A6A] mb-3", children: "[ 02 ] Selected Work" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { "data-guard": "work-h2", className: "font-display text-6xl tracking-tight", children: [
          "Recent ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "serif-italic text-7xl", children: "projects." })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] uppercase tracking-[0.3em] text-[#6A6A6A]", children: "2024 — 2025" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 grid grid-cols-4 gap-8", children: WORK.map((w, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: idx * 80, className: "flex flex-col group", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "#", className: "block", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `relative aspect-[3/4] overflow-hidden bg-gradient-to-br ${w.grad}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 grid-bg-fine opacity-40 group-hover:opacity-70 transition-opacity duration-700" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-4 left-4 text-[10px] font-mono uppercase tracking-widest text-paper mix-blend-difference", children: w.n }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-4 right-4 text-[10px] font-mono uppercase tracking-widest text-paper mix-blend-difference", children: w.year }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-x-0 bottom-0 p-5 transition-transform duration-700 group-hover:-translate-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-paper leading-none mix-blend-difference", style: {
            fontSize: "clamp(2rem,3.5vw,4rem)"
          }, children: w.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display italic font-light text-paper leading-none mix-blend-difference opacity-80", style: {
            fontSize: "clamp(1.4rem,2.4vw,2.6rem)"
          }, children: w.sub })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 flex justify-between text-[10px] uppercase tracking-[0.25em]", children: [
